...
export default function DashboardHero() {
  return (
    <section
      ...
      bg-gradient-to-br from-[#0c021f] to-[#1a0730]
      rounded-2xl border border-white/10 shadow-2xl backdrop-blur-md"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-8">
        ...
        <div>
          ...
          <button className="bg-white/10 hover:bg-white/20 transition text-white px-6 py-3 rounded-full text-sm font-medium shadow-md">
